...
export default function About() {
  ...
  return (
    <section className="w-[100%] relative  " >
      ...
      <div className="w-[100%] mt-10 relative flex justify-center items-center " >
        <div className="w-[1024px] max-[1024px]:max-w-[850px]  flex justify-center items-center  " >
          <section className="flex  relative max-[883px]:flex-col items-center justify-between " >
            <AboutText />

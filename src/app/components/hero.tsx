...
export default function Hero() {
    return (
        <section id="home" className="flex overflow-hidden    overflow-x-hidden  max-md:px-0  max-lg:h-fit max-lg:gap-[80px] max-lg:items-center max-[883px]:flex-col max-[883px]:mt-16  w-[100%] min-h-[90vh] items-center relative justify-around " >
            ...
            <div className="w-[1024px] max-[1024px]:w-[850px] flex justify-between max-[883px]:flex-col max-[883px]:mt-16 items-center gap-8" >
                <HeroText />
                <HeroImage />
            </div>
        </section>

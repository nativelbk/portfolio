    ...
    <motion.section transition={{ duration: 1 }} animate={{
      ...
      <div className="flex max-lg:gap-4 gap-6 max-[883px]:gap-8 max-[512px]:gap-3 max-[883px]:items-center flex-col " >
        ...
        <SplitText
          ...
          className="   max-[512px]:text-3xl max-[478px]:text-2xl max-[342px]:text-xl max-sm:text-4xl max-[883px]:text-4xl max-md:text-4xl max-lg:text-2xl text-4xl text-blue "
        >
